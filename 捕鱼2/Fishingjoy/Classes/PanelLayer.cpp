...
bool PanelLayer::init()
{
	...
	_goldCounter->setPosition(ccp(580, 19));

	ScheduleCountDown* countDown = ScheduleCountDown::create(this);

	_scheduleLabel = CCLabelTTF::create("80", "Thonburi", 52);
	_scheduleLabel->setColor(ccc3(160, 82, 45));
	_scheduleLabel->addChild(countDown);
	this->addChild(_scheduleLabel);
	_scheduleLabel->setPosition(ccp(480, 19));
